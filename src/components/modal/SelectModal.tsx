...
import { categories } from "../../data/DataOb";
...
const SelectModal = ({ selected, setSelected } : IProps) => {
        ...
        <>
          ...
          <div className="relative">
            ...
            <Transition
              ...
              leaveTo="opacity-0"
            >
              <Listbox.Options className="absolute z-10 max-h-28 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
